    ...
    <main>
        <aside class="sidebar">
            <div class="sidebar-logo">
                <img src="<?php echo get_field('mini_logo', 'option') ?>" />
            </div>
        </aside>
        <div class="body">
            <header class="header" data-aos="fade-down" data-aos-duration="1000">
                <nav class="nav">
                    ...
                    <div class="toggle-button">
                        <svg class="hamburger" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" style="fill: #484f5b"><path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z"></path></svg>
                        <svg class="equis" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" style="fill: #484f5b"><path d="m16.192 6.344-4.243 4.242-4.242-4.242-1.414 1.414L10.535 12l-4.242 4.242 1.414 1.414 4.242-4.242 4.243 4.242 1.414-1.414L13.364 12l4.242-4.242z"></path></svg>
                    </div>
                </nav>
            </header>

<footer class="footer" style="background-image: url(<?php echo get_field('footer_background', 'option') ?>);">
    <div class="footer-wrapper">
        <div class="footer-content">
            <div class="footer-content-left">
                <h3>Studio creativo</h3>
                <ul class="footer-menu">
                    <li class="footer-menu-item"><a href="#">/Nosotros</a></li>
                    <li class="footer-menu-item"><a href="#">/Servicios</a></li>
                    <li class="footer-menu-item"><a href="#">/Portafolio</a></li>
                    <li class="footer-menu-item"><a href="#">/Contacto</a></li>
                </ul>
            </div>
            <div class="footer-content-right">
                <p class="w-100-mobile">
                    <b>Lima, Perú</b>
                </p>
                <p class="w-50-mobile">
                    <b>Contacto</b> </br>
                    <span>hola@adcreando.com</span>
                </p>
                <p class="w-50-mobile">
                    <b>Contacto</b> </br>
                    <span>+51 989 205 677</span>
                </p>
            </div>
        </div>
        <div class="footer-copy">
            <div class="footer-copy-col">
                <img class="footer-logo" src="img/Logo-ADcreando.png" alt="">
            </div>
            <div class="footer-copy-col">
                <p>&copy;2022 ADcreando Studio creativo - Todos los derechos reservados</p>
            </div>
            <div class="footer-copy-col">
                <div class="social">
                    <?php if(get_field('whatsapp_url', 'option')): ?>
                        <div class="social-item">
                            <a href="<?php echo get_field('whatsapp_url', 'option') ?>">
